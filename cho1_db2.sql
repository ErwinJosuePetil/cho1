...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2025 at 08:36 AM
...
CREATE TABLE `maternity_records` (
  ...
  `prenatal_visit` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `maternity_records`
--

INSERT INTO `maternity_records` (`id`, `mother_id`, `staff_id`, `record_date`, `notes`, `complications`, `gestational_age`, `prenatal_visit`, `last_menstrual_period`, `pregnancy_status`, `admission_date`, `discharge_date`) VALUES
(1, 1, 1, '2025-03-05', 'qweqweq', 'qeqwe', 12, 12, '2025-03-13', 'good', '2025-03-07', '2025-03-05');
