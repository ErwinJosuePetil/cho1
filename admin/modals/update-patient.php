    ...
    <i class="fas fa-edit"></i>
            ...
            <div class="modal-body">
                <form action="update_record.php" method="POST">
                    ...
                    <div class="row"> <!-- Added missing equal sign for class -->
                        <div class="form-group col-md-4"> <!-- Added col-md-4 for responsive layout -->
                    ...
                    <div class="row"> <!-- Fixed the missing equal sign for class -->
                        <div class="form-group col-md-4"> <!-- Added col-md-4 for responsive layout -->
